...
#            csp.select_product(product_name)
    ...
    def test_that_only_plugin_reports_have_plugin_icon(self, mozwebqa):
        ...
        while not reports_page.is_plugin_icon_present:
            reports_page.click_next()

        Assert.true(reports_page.is_browser_icon_visibile)

        reports_page.click_plugin_filter()

        while not reports_page.is_browser_icon_present:
            reports_page.click_next()
