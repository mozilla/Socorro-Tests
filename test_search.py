...
class TestSearchForIdOrSignature:
    ...
    def test_that_when_item_not_available(self, mozwebqa):
        ...
        Assert.false(results.results_found, msg='https://crash-stats-dev.allizom.org/query/query')
    ...
    def test_that_search_for_valid_signature(self, mozwebqa):
        ...
        Assert.true(result.results_found, msg='https://crash-stats-dev.allizom.org/query/query')
    ...
    def test_that_advanced_search_drilldown_results_are_correct(self, mozwebqa):
        ...
        Assert.equal(results_page_count, cssr.total_items_label, msg='https://crash-stats.allizom.org/query/query?product=Firefox&version=ALL')
    ...
    def test_that_search_for_a_given_build_id_works(self, mozwebqa):
        ...
        if cs_advanced.results_found:
            ...
            Assert.equal(cs_advanced.query_results_text(1), "No results were found.", msg='https://crash-stats-dev.allizom.org/query/query')
    ...
    def test_that_filter_for_browser_or_plugin_filters_results(self, mozwebqa):
        ...
        Assert.true(cs_advanced.is_browser_icon_visibile, msg='https://crash-stats-dev.allizom.org/query/query')
        ...
        Assert.true(cs_advanced.is_plugin_icon_visibile, msg='https://crash-stats-dev.allizom.org/query/query')
